	...
	public void devoTrabalharComXML() {
		...
		.when()
			...
			.then()
				...
				.body("@id", is("3")) // como é XML para chegar até o ID é preciso incluir o @ para achar parametros.
				
				
				.rootPath("user.filhos")
				.body("name.size()", is(2))
				
				.detachRootPath("filhos") // esse comando volta para o anterior
				.body("filhos.name[0]", is("Zezinho"))
				.body("filhos.name[1]", is("Luizinho"))
				
				
				.appendRootPath("filhos") // incluir novamente o path
